...
CREATE TABLE IF NOT EXISTS defect_record (
    ...
    blade_mapping_info VARCHAR(500),
    shooting_angle DECIMAL(8,4),
    shooting_azimuth DECIMAL(8,4),
...
CREATE TABLE IF NOT EXISTS reshoot_record (
    ...
    blade_number INT,
    blade_position VARCHAR(50),
    required_angle DECIMAL(8,4),
    required_azimuth DECIMAL(8,4),
    actual_angle DECIMAL(8,4),
    actual_azimuth DECIMAL(8,4),
    angle_tolerance DECIMAL(8,4) DEFAULT 5.0,
    angle_deviation DECIMAL(8,4),
    ...
    comparison_opinion VARCHAR(1000),
    reshoot_operator VARCHAR(50),
    reshoot_order INT,
    is_completed BOOLEAN NOT NULL DEFAULT FALSE,
    is_angle_valid BOOLEAN,
    remark VARCHAR(500),
    is_deleted BOOLEAN NOT NULL DEFAULT FALSE,
    create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    update_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS maintenance_window (
    ...
    reservation_expire_time TIMESTAMP,
    work_order_code VARCHAR(50),
    work_order_url VARCHAR(500),
    maintenance_photos VARCHAR(2000),
    review_conclusion VARCHAR(30),
    review_opinion VARCHAR(1000),
    reviewer VARCHAR(50),
    review_time TIMESTAMP,
